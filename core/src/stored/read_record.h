...
DLL_IMP_EXP ReadContext *new_read_context(void);
DLL_IMP_EXP void FreeReadContext(ReadContext *read_context);
DLL_IMP_EXP void ReadContextSetRecord(DeviceControlRecord *dcr, ReadContext *read_context);
